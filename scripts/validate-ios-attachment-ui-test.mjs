...
const artifactDir =
  process.env.AI_CODE_IOS_ATTACHMENT_UI_TEST_ARTIFACT_DIR ??
  path.join(".tmp", "ios-attachment-ui-test");
const logPath =
  process.env.AI_CODE_IOS_ATTACHMENT_UI_TEST_LOG_PATH ??
  path.join(artifactDir, "ios-attachment-ui-test.log");
const metadataPath =
  process.env.AI_CODE_IOS_ATTACHMENT_UI_TEST_METADATA_PATH ??
  path.join(artifactDir, "attachment-ui-test.json");
const resultBundlePath =
  process.env.AI_CODE_IOS_ATTACHMENT_UI_TEST_RESULT_BUNDLE_PATH ??
  path.join(artifactDir, "ios-attachment-ui-test.xcresult");
